...
Вакансії, hiring, пошук кандидатів і "шукаємо media buyer/affiliate manager/bizdev" НЕ показуй у загальному звіті взагалі. Для вакансій є окрема кнопка "💼 Вакансії".
...
ВАЖЛИВО ПРО РОЗМІР ЗВІТУ:
Звіт має бути компактний, не довга стіна тексту.
- 5/5: максимум 8 найсильніших пунктів, кожен 3-4 короткі рядки.
- 4/5: максимум 8 пунктів, кожен одним рядком: що + цифра/GEO + посилання.
- 3/5: максимум 5 пунктів, тільки якщо є практична користь, одним рядком.
- 2/5 і 1/5 не показуй.
- Якщо схожих пунктів багато — згрупуй в один рядок і вкажи кількість.
...
Пріоритет показу:
1. Спочатку максимум 8 найсильніших 5/5
2. Потім максимум 8 найсильніших 4/5
3. Потім максимум 5 корисних 3/5

ВАКАНСІЇ:
У загальному звіті НЕ показуй вакансії. Навіть якісні вакансії мають іти тільки в окремий модуль "💼 Вакансії".
...
- без вакансій: вакансії йдуть тільки в окремий модуль "💼 Вакансії"
...
- Покажи максимум 8 найсильніших повідомлень 5/5.
- Кожен пункт 3-4 короткі рядки: що / цифри або GEO / посилання / дія.
- Якщо 5/5 немає — напиши: "Критичних 5/5 повідомлень не було".

⭐ Важливі повідомлення 4/5:
- Покажи максимум 8 повідомлень 4/5.
- Кожен пункт одним рядком: що + цифра/GEO + посилання.
- Якщо 4/5 немає — напиши: "Важливих 4/5 повідомлень не було".

🟡 Корисні 3/5:
- Показуй тільки ті 3/5, які мають практичну користь.
- Максимум 5, кожен одним рядком.
...
ЖОРСТКІ ПРАВИЛА:
- Фінальний звіт має бути компактний.
- 5/5: максимум 8 найсильніших пунктів, 3-4 короткі рядки на пункт.
- 4/5: максимум 8 пунктів, одним рядком на пункт.
- 3/5: максимум 5 пунктів, одним рядком і тільки якщо є практична користь.
- 2/5 і 1/5 в фінальному звіті не показуй.
- Вакансії не показуй у фінальному звіті.
- Прибери дублікати (однакове повідомлення з однаковим джерелом), якщо воно випадково потрапило в кілька часткових звітів.
- Якщо схожих пунктів багато — групуй в один рядок і вкажи кількість.
...
class AIService:
    ...
    async def summarize(self, messages: list[dict]) -> str:
        ...
        merge_user = (
            ...
            "за тим самим компактним форматом (Звіт за період, 🔥/⭐/🟡/💰/🧪/🗑️/✅), без вакансій:\n\n"
            + "\n\n".join(labeled)
        )
